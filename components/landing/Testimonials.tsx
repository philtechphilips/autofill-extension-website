...
export default function Testimonials() {
  const testimonials = [
    {
      quote: 'AutoFill AI removed the single largest bottleneck in our recruitment pipeline. We transitioned from manual entry to automated verification in 48 hours.',
      author: 'Sarah Chen',
      role: 'Head of Talent, Vercel',
      avatar: 'https://i.pravatar.cc/150?u=sarah',
    },
    {
      quote: 'The level of field detection accuracy is unprecedented. It understands complex form states that standard browser extensions simply ignore.',
      author: 'Marcus Rodriguez',
      role: 'Principal Engineer, Linear',
      avatar: 'https://i.pravatar.cc/150?u=marcus',
    },
    {
      quote: 'Finally, a developer-first approach to identity management. Secure, local-first, and incredibly fast. It is a staple in my daily workflow.',
