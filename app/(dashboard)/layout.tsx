...
const SidebarItem = ({ href, icon: Icon, label, active }: SidebarItemProps) => (
    <Link href={href}>
        <div className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${active
            ...
            <Icon className={`w-5 h-5 transition-colors ${active ? 'text-white' : 'text-white/70 group-hover:text-white/80'}`} />
        ...
        <div className="min-h-screen bg-onyx flex">
            ...
            <aside className="hidden lg:flex flex-col w-72 border-r border-white/[0.05] bg-deep-navy/50 backdrop-blur-xl fixed inset-y-0">
                <div className="p-8">
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        <span className="text-xl font-bold text-white tracking-tighter">AutoFill</span>
                    </Link>
                </div>
            ...
            <header className="lg:hidden fixed top-0 w-full h-16 border-b border-white/[0.05] bg-deep-navy/80 backdrop-blur-xl z-50 flex items-center justify-between px-6">
                <Link href="/" className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-white tracking-tighter text-lg">AutoFill</span>
                </Link>
                <button
