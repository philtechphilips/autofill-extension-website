  ...
  return (
    <div className="mx-auto space-y-12">
      ...
      >
        ...
        <div className="relative bg-white/[0.03] border border-white/[0.08] rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="space-y-6 text-center md:text-left">
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-center md:justify-start gap-4">
                ...
                <span className="text-xl font-medium text-white/40 mb-2">
                  Credits
                </span>
              </div>
            </div>
      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {packs.map((pack, i) => (
            ...
            >
              {pack.recommended && (
                <div className="absolute -top-3 left-6 bg-brand-accent text-white text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full shadow-lg shadow-brand-accent/20">
                  Best Value
                </div>
              )}
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="text-white/40 text-[11px] font-medium uppercase tracking-widest ml-1">
                ...
                <ul className="space-y-4">
                  {pack.features.map((feature, j) => (
                    <li
                      key={j}
                      className="flex items-center gap-3 text-sm text-white/60 font-light group-hover:text-white/80 transition-colors"
                    >
      ...
      <div className="pt-12 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 text-white/40 border-l border-white/10 pl-6">
