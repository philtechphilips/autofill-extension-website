...
export default function Demo() {
  return (
    <section id="demo" className="relative py-32 px-6 overflow-hidden bg-onyx">
          ...
          <div className="p-10 border-t border-white/[0.03] bg-gradient-to-b from-transparent to-white/[0.01]">
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <p className="text-[12px] text-white/70 font-light uppercase tracking-widest font-mono">
