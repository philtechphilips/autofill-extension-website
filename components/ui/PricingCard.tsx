    ...
    >
      ...
      <div className="flex flex-col gap-10">
        <div className="space-y-4">
          <h3 className="text-sm font-semibold text-white/80 uppercase tracking-widest">{name}</h3>
        ...
        <ul className="flex flex-col gap-4">
          {features.map((feature, index) => (
            <li key={index} className="flex items-start gap-4 text-[13px] text-white/80 font-light">
